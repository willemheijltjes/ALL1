...
%
However, we do conjecture that additive monomial nets could be restricted to some notion of canonical form, which would be equivalent to the notion induced by \emph{expansion tree proofs}, provide another approach to first-order quantification for classical logic \cite{Miller-1987,Heijltjes-2010}.
%
...
%We have presented two notions of first-order additive proof net, witness nets and unification nets, to canonically capture the two natural notions of proof identity for first-order additive linear logic.
%
The table in Figure~\ref{fig:results} summarizes the results of our paper and the observations in this section, where the column on expansion trees is speculative since they only exist for classical logic, and not (yet) exist for $\all$.
