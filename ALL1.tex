...
%We present two solutions to the \emph{proof-net problem}, finding a canonical representation of proofs, for additive linear logic (\all) extended with first-order quantification (\all1).

%\all is the fragment of linear logic \cite{Girard-1987} that describes sums and products, and their canonical morphisms: projections, injections, and diagonals. The logic represents a rich but tractable microcosm in which to explore important semantic ideas. By the duality between sum and product 
...
%
%We would like to thank the anonymous referees for their constructive feedback. Dominic would like to thank his host, Wes Holliday, at the UC Berkeley Logic Group. The first author was supported by EPSRC Project EP/R029121/1.
...
In this section we give the rule permutations of {\all1} sequent calculus.
